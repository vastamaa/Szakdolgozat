    ...
    render() {
        ...
        return (
            <div className='BaseSize'>
                ...
                <input className='login-input forgot' type="email" name='email' placeholder='Enter your email address' id='email' onInvalid={EmailChange} onChange={EmailChange} required></input><br />
                <p style={{ float: 'left'}} className='none' id='emailerr'>Invalid Email (@ , .com)</p><br />
                </div>
                <button  type='submit' className='login-btn' id='ForgotButton'>Submit</button>
                </form>
            </div>
        );
    }
