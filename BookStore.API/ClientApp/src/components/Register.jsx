          ...
          >
            <div className="login-form-group">
              ...
              <input
                ...
                onInvalid={FirstNameChange}
                id="firstName"
                onBlur={FirstNameChange}
                required
              ></input>
              <p className="none" id="firstnameerr">
                Must contain atleast 3 charachters
              </p>
            </div>
            <div className="login-form-group">
              ...
              <input
                ...
                onInvalid={LastNameChange}
                id="lastName"
                onChange={LastNameChange}
                required
              ></input>
              <p className="none" id="lastnameerr">
                Must contain atleast 3 charachters
              </p>
            </div>
            <div className="login-form-group">
              ...
              <input
                ...
                onInvalid={usernNameChange}
                id="userName"
                onChange={usernNameChange}
                required
              ></input>
              <p className="none" id="usernameerr">
            ...
            <div className="login-form-group">
              ...
              <input
                ...
                required
              ></input>
              <p className="none" id="passworderr">
                Must contain atleast 5 charachters <br></br> 1 Capital, 1
                Special Character
              </p>
            </div>
            <div className="login-form-group">
              ...
              <input
                ...
                required
              ></input>
              <p className="none" id="passwordmerr">
