...
namespace TestAPI.Controllers
{
    ...
    public class PublishersController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdatePublisherById(int id, [FromBody] PublisherDto publisher)
        {
            ...
            if (result is null)
            {
                return BadRequest(new ResponseModel { Status = "Error!", Message = "The publisher has not been updated!" });
            }

            return Ok(new ResponseModel { Status = "Success!", Message = "The publisher has been successfully updated!" });
        }
